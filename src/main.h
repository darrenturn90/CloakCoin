...
static const int LAST_POW_BLOCK = 10080; // at 60 second blocks will be about 7 days from launch
...
static const uint256 hashGenesisBlock("0x0000083c1e4f3ba9de8cca017c99c596980a91a2875c4b151d28fc0de355bb21");
static const uint256 hashGenesisBlockTestNet("0x0000083c1e4f3ba9de8cca017c99c596980a91a2875c4b151d28fc0de355bb21");
...
public:
    ...
    {
        // CloakCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // CloakCoin: get transaction coin age
...
public:
    ...
    // CloakCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // CloakCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // CloakCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // CloakCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // CloakCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // CloakCoin: block index flags
    enum  
    {
